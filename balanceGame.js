...
class BalanceGameManager {
    constructor() {
        ...
        this.formulaTo3DMap = {
            ...
            'CaCO₃': { key: 'calciumCarbonate', name: 'Калциев карбонат (CaCO₃)' },
            'Ca(OH)₂': { key: 'calciumHydroxide', name: 'Калциев хидроксид (Ca(OH)₂)' },
            'CaSO₄': { key: 'calciumSulfate', name: 'Калциев сулфат (CaSO₄)' },
            'Fe': { key: 'iron', name: 'Желязо (Fe)' },
            'Fe₂O₃': { key: 'ironOxide', name: 'Железен оксид (Fe₂O₃)' },
            'FeSO₄': { key: 'ironSulfate', name: 'Железен(II) сулфат (FeSO₄)' },
            'Fe₂(SO₄)₃': { key: 'ironSulfateComplex', name: 'Железен(III) сулфат (Fe₂(SO₄)₃)' },
            'Al': { key: 'aluminum', name: 'Алуминий (Al)' },
            'Al₂O₃': { key: 'aluminumOxide', name: 'Алуминиев оксид (Al₂O₃)' },
            'Zn': { key: 'zinc', name: 'Цинк (Zn)' },
            'ZnCl₂': { key: 'zincChloride', name: 'Цинков хлорид (ZnCl₂)' },
            'HCl': { key: 'hydrogenChloride', name: 'Хлороводород (HCl)' },
            'H₂SO₄': { key: 'sulfuricAcid', name: 'Сярна киселина (H₂SO₄)' },
            'P': { key: 'phosphorus', name: 'Фосфор (P)' },
            'P₂O₅': { key: 'phosphorusPentoxide', name: 'Фосфорен пентаоксид (P₂O₅)' },
            'K₂Cr₂O₇': { key: 'potassiumDichromate', name: 'Калиев дихромат (K₂Cr₂O₇)' },
            'K₂SO₄': { key: 'potassiumSulfate', name: 'Калиев сулфат (K₂SO₄)' },
            'Cr₂(SO₄)₃': { key: 'chromiumSulfate', name: 'Хром(III) сулфат (Cr₂(SO₄)₃)' },
            'KMnO₄': { key: 'potassiumPermanganate', name: 'Калиев перманганат (KMnO₄)' },
            'KCl': { key: 'potassiumChloride', name: 'Калиев хлорид (KCl)' },
            'MnCl₂': { key: 'manganeseChloride', name: 'Манганов хлорид (MnCl₂)' },
            'Cu': { key: 'copper', name: 'Мед (Cu)' },
            'HNO₃': { key: 'nitricAcid', name: 'Азотна киселина (HNO₃)' },
            'Cu(NO₃)₂': { key: 'copperNitrate', name: 'Меден нитрат (Cu(NO₃)₂)' },
            'NO': { key: 'nitricOxide', name: 'Азотен оксид (NO)' },
            'C₃H₈': { key: 'propane', name: 'Пропан (C₃H₈)' },
            'C₂H₆': { key: 'ethane', name: 'Етан (C₂H₆)' },
            'C₈H₁₈': { key: 'octane', name: 'Октан (C₈H₁₈)' },
